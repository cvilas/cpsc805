...
//==================================================================
// SceneReader::getNumPhotons
//==================================================================
int SceneReader::getNumPhotons()
{
 return d_numPhotons;
}
...
//==================================================================
// SceneReader::getRecursionDepth
//==================================================================
int SceneReader::getRecursionDepth()
{
 return d_recursionDepth;
}
...
void SceneReader::readCommonProperties(section_t *section, Object *object)
{
 ...
 object->setTranslation(vec.x, vec.y, vec.z);

 getVectorRecord(section, "rotate", vec, vector3d_t(0,0,0));
 object->setRotation(vec.x, vec.y, vec.z);
}
...
Object *SceneReader::readInfinitePlane(section_t *section)
{
 ...
 getVectorRecord(section, "normal", vec, vector3d_t(0,0,0));
 getScalarRecord(section, "distance", sc, 0);
 ((InfinitePlane *)object)->setPosition(vec, sc);
...
Object *SceneReader::readCheckerBoard(section_t *section)
{
 ...
 getVectorRecord(section, "normal", vec, vector3d_t(0,0,0));
 getScalarRecord(section, "distance", sc, 0);
 ((CheckerBoard *)object)->setPosition(vec, sc);
...
void SceneReader::readGlobalSettings(section_t *section)
{
 ...
 getScalarRecord(section, "recursion_depth", sc, 2);
  d_recursionDepth = (int)sc;

 getScalarRecord(section, "photons", sc, 0);
  d_numPhotons = (int)sc;
