...
transform_t translate(double x, double y, double z);
transform_t rotate(double rx, double ry, double rz);
transform_t rotate_about(vector3d_t axis, double angle);
transform_t inverse(transform_t t);
void getRotation(const transform_t &t, double &rx, double &ry, double &rz);
vector3d_t getTranslation(transform_t t);
